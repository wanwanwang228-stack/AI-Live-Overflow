...
class OverlayService : Service() {
    ...
    companion object {
        ...
        const val PET_W = 200
        const val PET_H = 220
        val HTML = """<!DOCTYPE html><html><head><meta charset=utf-8><style>*{margin:0;padding:0}body{width:200px;height:220px;background:#f8c8d0;position:relative;overflow:hidden}svg{position:absolute;left:50%;top:50%;margin-left:-70px;margin-top:-70px;width:140px;height:140px}</style></head><body><svg viewBox="0 0 140 140" xmlns="http://www.w3.org/2000/svg"><ellipse cx="70" cy="74" rx="56" ry="50" fill="#e8e0d8" stroke="#888" stroke-width="2.5"/><ellipse cx="26" cy="34" rx="17" ry="20" fill="#e8e0d8" stroke="#888" stroke-width="2.5" transform="rotate(-15,26,34)"/><ellipse cx="114" cy="34" rx="17" ry="20" fill="#e8e0d8" stroke="#888" stroke-width="2.5" transform="rotate(15,114,34)"/><ellipse cx="26" cy="34" rx="8" ry="12" fill="#ffd0d8" transform="rotate(-15,26,34)"/><ellipse cx="114" cy="34" rx="8" ry="12" fill="#ffd0d8" transform="rotate(15,114,34)"/><ellipse cx="70" cy="70" rx="42" ry="35" fill="#fafafa" stroke="#888" stroke-width="1.8"/><ellipse cx="54" cy="64" rx="7" ry="9.5" fill="#444"/><ellipse cx="86" cy="64" rx="7" ry="9.5" fill="#444"/><circle cx="56" cy="60" r="2.5" fill="#fff"/><circle cx="88" cy="60" r="2.5" fill="#fff"/><path d="M60 82 Q70 90 80 82" fill="none" stroke="#777" stroke-width="2" stroke-linecap="round"/><ellipse cx="38" cy="76" rx="9" ry="6" fill="#ffb3b3" opacity=".4"/><ellipse cx="102" cy="76" rx="9" ry="6" fill="#ffb3b3" opacity=".4"/><ellipse cx="44" cy="122" rx="14" ry="8" fill="#d8d0c8" stroke="#888" stroke-width="1.5"/><ellipse cx="96" cy="122" rx="14" ry="8" fill="#d8d0c8" stroke="#888" stroke-width="1.5"/><path d="M124 70 Q140 54 134 84 Q128 98 118 92" fill="none" stroke="#888" stroke-width="2"/></svg></body></html>"""
    }
